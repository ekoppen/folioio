...
-- Add specific album name translations
...
translation_value = EXCLUDED.translation_value, updated_at = now();

-- Add specific album description translations
INSERT INTO translations (translation_key, language_code, translation_value) VALUES
...
-- Add contact modal translations
INSERT INTO translations (translation_key, language_code, translation_value) VALUES
...
-- Add about section and skills translations
INSERT INTO translations (translation_key, language_code, translation_value) VALUES
